...
background-image: linear-gradient(315deg, #af8c9d 0%, #8cacac 74%);
            ...
            <div class="row about-cols">
                ...
                <div class="col-md-6 col-sm-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="about-col">
                        ...
                        <img src="img/demat.png" alt="" width="80%">
    ...
    <div class="container">
        ...
        <p>The shares that you buy and sell on a stock exchange (BSE or NSE), are stored in a Demat Account. The shares
            ...
            shares, your broker credits your Demat account with shares. These shares are reflected in your statement of
            holdings (You can see details of the shares you have bought in your account). When you sell the shares in
            your Demat account, your
            account is debited (Shares are debited/move out of your Demat account) and money is paid to you for the
            shares you sell). You need to submit a DIS (Delivery Instruction Slip), to your broker, where you fill in
            the details of the shares
            you sell. There are 2 depositories in India. There are the National Securities Depositories Limited (NSDL)
            and the Central Depositories Services Limited (CDSL).
        ...
        <div style="background-color: lightgray; padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;"
            ...
            <ul>
                <li>A Demat account can be opened with a depository participant, which may be a bank or a stock broker
                    who has a license to do so. You must have a PAN card to open a Demat account as it is very important
                    for your KYC (Know Your Clients),
                    norms.
                </li>
                <li>You also require an identity proof (Voters card or your PAN card itself) and an address proof
                    (Passport or a Driver’s License). You have to sign across the copies of the passport and the PAN
        ...
        <div style="background-color: lightgray; padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;"
            ...
            <ul>
                <li>Demat account opening fees:This covers the cost of the agreement with the depository participant.
                </li>
                <li>Annual maintenance fees:These fees are charged in advance mainly for the maintenance of the account
                    and the services rendered.
                </li>
                <li>Custodian fees:This is mainly charged for the safe keeping of shares in the Demat account and is
                    charged based on the number of shares held in the account.
                </li>
                <li>Brokerage fees:Whenever a share is bought or sold, certain transaction or brokerage fees are
                    charged.
                </li>
                <li>Dematerialization fees:In order to convert physical shares to the dematerialized form, certain
        ...
        <div style="background-color: lightgray; padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;"
            ...
            <ul>
                <li>You can only store shares in a Demat account. In order to buy and sell shares you require a trading
                    account.
                </li>
                ...
                <li>Money is debited from your savings bank account and shares are automatically credited to your Demat
                    account.
                </li>
                <li>You sell shares through your trading account
                </li>
                <li>Money is credited to your savings bank account and shares are automatically debited from your Demat
                    account.
                </li>
            </ul>
        ...
        <div style="background-color: lightgray; padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;"
            ...
            <ul>
                <li>You can open a basic services Demat account, if you are a first time investor in the stock market.
                    You can also open a basic services Demat account, if you already have a Demat account and you are
        ...
        <!--==============fiveth card for content============-->
        <div style="background-color: lightgray; padding: 20px; border: 1px solid rgb(219, 209, 209); border-radius: 10px;"
            id="card">
            <h5>Why you need a basic services Demat account?
            </h5>
            <ul>
                <li>If you are a small investor in the stock markets with holdings less than INR 50,000 then it would be
                    wise to opt for a basic services Demat account also called a no-frills Demat account. There are no
                    annual maintenance charges (maintenance
                    charges are nil), if the holdings in your Demat account are less than INR 50,000.
                </li>
                <li>If the value of the shares in your Demat account (value of your holdings) is between INR 50,000 –
                    INR 2, 00,000, then you will have to pay an annual maintenance fee of INR 100. If the value of the
                    shares in your account exceeds INR
                    2 lakhs, then you will have to pay an annual maintenance fee, which is the same as that of any
                    normal Demat account. You have the option to convert your Demat account to a basic services Demat
